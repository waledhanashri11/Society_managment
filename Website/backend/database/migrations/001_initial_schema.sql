...
CREATE INDEX idx_flats_owner_id ON flats(owner_id);
CREATE INDEX idx_maintenance_bills_resident_id ON maintenance_bills(resident_id);
CREATE INDEX idx_maintenance_bills_status ON maintenance_bills(payment_status);
...
CREATE INDEX idx_activities_resident_id ON activities(resident_id);
