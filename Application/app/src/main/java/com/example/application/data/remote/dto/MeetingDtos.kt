...
data class MeetingActionDto(val id: String?, @SerializedName("action_text") val actionText: String?, @SerializedName("assigned_to") val assignedTo: String?, @SerializedName("assignee_name") val assigneeName: String?, @SerializedName("due_date") val dueDate: String?, val priority: String?, val status: String?)
...
data class MeetingActionSaveRequest(@SerializedName("meeting_id") val meetingId: String, @SerializedName("action_text") val actionText: String, @SerializedName("assigned_to") val assignedTo: String? = null, @SerializedName("due_date") val dueDate: String? = null, val priority: String = "Normal")
