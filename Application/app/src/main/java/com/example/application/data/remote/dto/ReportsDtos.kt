...
data class OverallReportSummaryDto(val totalCollection: Double=0.0,val totalIncome: Double=0.0,val totalExpenses: Double=0.0,val netBalance: Double=0.0,val maintenanceGenerated: Double=0.0,val maintenanceCollected: Double=0.0,val pendingAmount: Double=0.0,val penaltyCollected: Double=0.0,val writeOffAmount: Double=0.0,val totalTransactions: Int=0,val paidResidents: Int=0,val pendingResidents: Int=0)
data class OverallMonthDto(val month:Int,val year:Int,val totalCollection:Double=0.0,val totalExpenses:Double=0.0,val netBalance:Double=0.0,val pendingAmount:Double=0.0,val penaltyCollected:Double=0.0,val writeOffAmount:Double=0.0,val totalTransactions:Int=0)
data class OverallTransactionDto(val id:String,val date:String?,val transactionId:String?,val type:String?,val category:String?,val residentOrParty:String?,val flat:String?,val description:String?,val paymentMode:String?,val credit:Double=0.0,val debit:Double=0.0,val balance:Double=0.0,val status:String?,val referenceType:String?,val referenceId:String?)
data class OverallCollectionDto(val id:String,val date:String?,val resident:String?,val flat:String?,val billMonth:String?,val billAmount:Double=0.0,val penalty:Double=0.0,val writeOff:Double=0.0,val amountPaid:Double=0.0,val remaining:Double=0.0,val paymentMode:String?,val status:String?)
data class OverallExpenseDto(val id:String,val date:String?,val category:String?,val description:String?,val vendor:String?,val amount:Double=0.0,val paymentMode:String?,val status:String?)
data class OverallPendingDto(val id:String,val resident:String?,val flat:String?,val month:String?,val originalBill:Double=0.0,val penalty:Double=0.0,val writeOff:Double=0.0,val paid:Double=0.0,val remaining:Double=0.0,val status:String?)
data class OverallPaginationDto(val page:Int=1,val limit:Int=30,val totalRecords:Int=0,val totalPages:Int=1)
data class OverallPeriodDto(val from:String?,val toExclusive:String?)
data class OverallReportDto(val success:Boolean=false,val societyName:String?=null,val financialYear:String?=null,val period:OverallPeriodDto?=null,val summary:OverallReportSummaryDto=OverallReportSummaryDto(),val months:List<OverallMonthDto>?=null,val transactions:List<OverallTransactionDto> = emptyList(),val collections:List<OverallCollectionDto> = emptyList(),val expenses:List<OverallExpenseDto> = emptyList(),val pending:List<OverallPendingDto> = emptyList(),val pagination:OverallPaginationDto=OverallPaginationDto())
