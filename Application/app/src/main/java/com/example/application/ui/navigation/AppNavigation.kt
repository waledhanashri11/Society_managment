...
fun SocietyNavGraph(
    ...
    NavHost(
        ...
        composable(AppRoute.AdminMeetings.route) {
            AdminMeetingsScreen(onBack = { navController.popBackStack() })
        }

        composable(AppRoute.AdminEvents.route) {
            AdminEventsScreen(onBack = { navController.popBackStack() })
        }
